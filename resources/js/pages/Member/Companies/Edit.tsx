...
export default function Edit({ company, errors, auth }: EditProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        },
        {
            ...
            href: `/member/my-companies/${company.slug}/edit`,
        },
    ];
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('member.companies.update', company.slug), {
            onSuccess: () => {
                toast({
                    title: t('member.companies.messages.updated'),
                    description: t('member.companies.messages.update_success'),
                });
            },
            onError: () => {
                toast({
            ...
            <form onSubmit={handleSubmit} className="mt-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        {t('member.companies.edit_description')}
                                    </CardDescription>
                                </CardHeader>
                ...
                <div className="mt-6 flex justify-end space-x-4">
                    ...
                    <Button type="submit" disabled={processing}>
                        {t('member.companies.actions.update')}
                    </Button>
                </div>
            </form>
        </MemberLayout>
